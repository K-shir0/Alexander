...
class Palette{
  static const Color signButtonColor = Color(0xffffc400); //メインカラー
  static const Color mainTextColor = Color(0xff83acb4); //テキスト
  static const Color accentTextColor = Color(0xff687c80); //テキスト2
  ...
  static const Color bgContentsHighLightColor = Color(0xfff0f5f5); //コンテンツハイライト背景
  static const Color bgContentsDarkColor = Color(0xfff0f5f5); //背景3
  ...
  static const Color bgaccount = Color(0xfff0f5f5); //背景3
  static const Color bgmain = Color(0x00f5f7f7); //背景2
  static const Color whitecolor = Color(0xfffafafa); //背景1
